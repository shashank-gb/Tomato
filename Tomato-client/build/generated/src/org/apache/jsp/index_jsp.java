...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/assets/JSP/login.jsp");
    _jspx_dependants.add("/assets/JSP/signup.jsp");
    _jspx_dependants.add("/assets/JSP/navBarForHome.jsp");
    _jspx_dependants.add("/assets/JSP/connection.jsp");
    _jspx_dependants.add("/assets/JSP/loginSignupChecker.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <link type=\"text/css\" rel=\"stylesheet\" href=\"CSS/modal.css\">\n");
      ...
      out.write("                            <div style=\"height: 1rem;\"></div>\n");
      out.write("                            <div class=\"fullname-inner\">\n");
      out.write("                                <input name=\"phone\" class=\"mail-input\" type=\"number\" maxlength=\"10\" minlength=\"10\" placeholder=\"Phone Number\" autocomplete=\"off\">\n");
      out.write("                            </div>\n");
      ...
      out.write("\n");
      out.write("        <header>\n");
      out.write("            <!-- Navigation Bar for index-->\n");
      out.write("            ");
      out.write("\n");
      out.write("\n");
      out.write("\n");
    ...
    try{
      ...
      out.write("        $('.order-btn').attr('disabled', true);\n");
      out.write("        $('.pay-type').hide();\n");
      out.write("\n");
      out.write("    ");
 ...
 if ((session.getAttribute("loginStatus") == registerModel.Status.success)) {
      ...
      out.write("        $('.after-login').show();\n");
      out.write("        $('.order-btn').attr('disabled', false);\n");
      out.write("        $('.pay-type').show();\n");
      out.write("        $('.pay-type').text('cash');\n");
      out.write("\n");
      out.write("    ");
