<%-- 
    Document   : login.jsp
    Created on : 9 Nov, 2020, 9:40:16 PM
    Author     : SHASHANKgb
--%>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <section class="mb-wrapper login-form">
                    <form method="POST" action="register" name="signin-form" class="w-100">
                        <div class="phno" type="number" inputmode="numeric">
                            <div class="mail-inner">
                                <input name="email" class="phone-input" type="text" placeholder="Email" autocomplete="off">
                            </div>
                            <div style="height: 1rem;"></div>
                            <div class="pass-inner">
                                <input name="password" class="phone-input" type="password" placeholder="Password" autocomplete="off">
                            </div>
                        </div>
                    ...
                    <section class="mb-wrapper login-unsuccess">
                        <p class="error">Email and Password does not match..</p>
                    </section>
<!--                    <div class="hr-text">
                        <hr class="divider">
                        <span>or</span>
