...
<body>
    <header class="header-container">
        <div class="header-wrapper">
            <h3 class="text-uppercase"><a href="index.html">Tomato</a></h3>
        </div>
    </header>
    <div class="root">
        <div class="wrapper">
        ...
        <div class="wrapper">
            <section class="hotel-details-container">
                <section class="hotel-details">
                    <h1 class="heading res-name">Rockings Rock</h1>
                    <section class="details">
                        <div class="type-v">Veg</div>
                        <div class="type-nv">Non-veg</div>
                        <div class="address">Davanagere</div>
                    </section>
                                    ...
                                    <div class="food-details-container">
                                        <div class="food-details-inner">
                                            <div class="food-details-wrapper">
                                                <h4 class="heading food-name">Gobi</h4>
                                                <div class="stars">
                                            ...
                                            <div class="order-btn-container">
                                                <div class="order-btn">
                                                    <input type="button" value="-" class="negative" onclick="increment()">
                                                    <span class="add txt">Add</span>
                                                    <input type="button" class="qty add" value="">
                                                    <input type="button" value="+" class="positive" onclick="increment()">
                                                </div>
                            ...
                            <section class="tot-amt-calculator ">
                                <div class="tot-amt-container">
                                    <div class="amt-btn-container">
                                        <span class="subtotal">Subtotal : <span class="sub-amt">0</span></span>
...
<script>
    $(document).ready(function(){
        if($('.sub-amt').text() === "0"){
            ...
            $('.tot-amt-container').hide();
        }else{
            $('.cont-btn').attr('disabled', false);
            $('.tot-amt-container').show();
        }
